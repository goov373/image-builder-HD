...
const DesignSystemPanel = ({ designSystem, onUpdate, onClose, isOpen }) => {
  ...
  const purpleMeshes = [
    ...
    'radial-gradient(at 50% 0%, #c4c8e8 0px, transparent 70%), radial-gradient(at 25% 50%, #a8aed4 0px, transparent 60%), radial-gradient(at 0% 100%, #818cf8 0px, transparent 55%), radial-gradient(at 100% 100%, #6466e9 0px, transparent 55%), linear-gradient(0deg, #5558d9 0%, #6466e9 40%, #818cf8 70%, #a8aed4 100%)',
  ...
  const orangeGradients = [
    'linear-gradient(135deg, #F97316 0%, #f59e0b 40%, #fbbf24 70%, #fcd34d 100%)',   // Orange to Gold (smooth)
    'linear-gradient(135deg, #fb923c 0%, #F97316 50%, #ea580c 100%)',   // Light Orange to Deep Orange
    'linear-gradient(180deg, #fcd34d 0%, #fbbf24 35%, #f59e0b 65%, #F97316 100%)',   // Vertical Gold to Orange (smooth)
  ];
