...
const DesignSystemPanel = ({ designSystem, onUpdate, onClose, isOpen }) => {
  ...
  const purpleMeshes = [
    ...
    'linear-gradient(135deg, transparent 0%, transparent 40%, rgba(100, 102, 233, 0.4) 40%, rgba(129, 140, 248, 0.2) 70%, transparent 70%), linear-gradient(135deg, rgba(85, 88, 217, 0.5) 0%, rgba(85, 88, 217, 0.3) 30%, transparent 30%), linear-gradient(135deg, #3d3fa8 0%, #5558d9 100%)',
    'linear-gradient(160deg, transparent 0%, transparent 25%, rgba(129, 140, 248, 0.35) 25%, rgba(129, 140, 248, 0.15) 50%, transparent 50%), linear-gradient(160deg, transparent 50%, rgba(100, 102, 233, 0.4) 50%, rgba(100, 102, 233, 0.2) 75%, transparent 75%), linear-gradient(135deg, #4a4dcf 0%, #6466e9 100%)',
    'linear-gradient(145deg, rgba(129, 140, 248, 0.5) 0%, rgba(129, 140, 248, 0.2) 20%, transparent 20%), linear-gradient(145deg, transparent 35%, rgba(100, 102, 233, 0.45) 35%, rgba(100, 102, 233, 0.2) 55%, transparent 55%), linear-gradient(145deg, transparent 70%, rgba(85, 88, 217, 0.5) 70%, rgba(74, 77, 207, 0.3) 90%, transparent 90%), linear-gradient(135deg, #3d3fa8 0%, #5558d9 100%)',
  ];
