...
const DesignSystemPanel = ({ designSystem, onUpdate, onClose, isOpen }) => {
  ...
  const purpleMeshes = [
    ...
    'repeating-linear-gradient(135deg, #3d3fa8 0px, #4a4dcf 8px, #5558d9 16px, #6466e9 24px, #5558d9 32px, #4a4dcf 40px, #3d3fa8 48px), linear-gradient(135deg, #4a4dcf 0%, #5558d9 100%)',
    'repeating-linear-gradient(45deg, #4a4dcf 0px, #5558d9 6px, #6466e9 12px, #818cf8 18px, #6466e9 24px, #5558d9 30px, #4a4dcf 36px), linear-gradient(135deg, rgba(61, 63, 168, 0.5) 0%, rgba(100, 102, 233, 0.3) 100%)',
    'repeating-linear-gradient(120deg, #3d3fa8 0px, #4a4dcf 10px, #5558d9 20px, #4a4dcf 30px, #3d3fa8 40px), repeating-linear-gradient(60deg, transparent 0px, rgba(100, 102, 233, 0.3) 15px, transparent 30px), linear-gradient(135deg, #4a4dcf 0%, #5558d9 100%)',
  ];
