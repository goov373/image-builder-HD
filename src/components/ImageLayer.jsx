    ...
    >
      ...
      {isEditMode && (
        <>
          ...
          {/* Instructions */}
          <div className="absolute top-2 left-1/2 -translate-x-1/2 bg-black/80 rounded-lg px-4 py-1.5 z-40">
            <p className="text-white text-[10px] text-center whitespace-nowrap">
