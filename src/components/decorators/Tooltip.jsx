...
const Tooltip = ({
  ...
  const arrowStyles = {
    top: {
      ...
      borderTop: `${s.arrow}px solid ${v.bg}`,
    ...
    bottom: {
      ...
      left: '50%',
      transform: 'translateX(-50%)',
      borderBottom: `${s.arrow}px solid ${v.bg}`,
      borderLeft: `${s.arrow}px solid transparent`,
      borderRight: `${s.arrow}px solid transparent`,
    },
    left: {
      ...
      borderLeft: `${s.arrow}px solid ${v.bg}`,
      borderTop: `${s.arrow}px solid transparent`,
      borderBottom: `${s.arrow}px solid transparent`,
    },
    right: {
      left: -s.arrow,
      top: '50%',
      transform: 'translateY(-50%)',
      borderRight: `${s.arrow}px solid ${v.bg}`,
      borderTop: `${s.arrow}px solid transparent`,
      borderBottom: `${s.arrow}px solid transparent`,
    },
  };
  ...
  return (
    ...
    >
      ...
      {/* Arrow */}
      {hasArrow && <div className="absolute w-0 h-0" style={arrowStyles[position]} />}
    </div>
  );
};
