...
export const initialEblasts: Eblast[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        sectionType: 'hero',
        variants: [
          { headline: "Screen Deals 10x Faster", body: "AI-powered rent comps and underwriting in seconds, not hours.", formatting: {} },
          { headline: "Your Unfair Advantage", body: "Get the data your competitors wish they had.", formatting: {} },
          { headline: "Stop Guessing. Start Knowing.", body: "Real-time market intelligence for multifamily professionals.", formatting: {} }
        ],
        currentVariant: 0,
        currentLayout: 0,
        layoutVariant: 0,
      ...
      },
      {
        ...
        sectionType: 'feature',
        variants: [
          { headline: "Rent Comps in 60 Seconds", body: "Enter any address. Get accurate rent comps, expense benchmarks, and NOI projections instantly.", formatting: {} },
          { headline: "Market Data That Moves", body: "Daily updates. Real-time signals. The forecast that never gets stale.", formatting: {} },
          { headline: "Built for Speed", body: "The fastest teams win the best deals. We make sure that's you.", formatting: {} }
        ],
        currentVariant: 0,
        currentLayout: 0,
        layoutVariant: 0,
