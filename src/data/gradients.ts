...
export const purpleLinearGradients: GradientDefinition[] = [
  ...
  {
    id: 'pl-diagonal-top-left',
    name: 'Diagonal Top-Left',
    category: 'purple-linear',
    css: 'linear-gradient(135deg, #c7d2fe 0%, #a5b4fc 25%, #818cf8 50%, #6466e9 75%, #5558d9 100%)',
  },
  {
    id: 'pl-diagonal-top-right',
    name: 'Diagonal Top-Right',
    category: 'purple-linear',
    css: 'linear-gradient(225deg, #c7d2fe 0%, #a5b4fc 25%, #818cf8 50%, #6466e9 75%, #5c5fdb 100%)',
  },
  {
