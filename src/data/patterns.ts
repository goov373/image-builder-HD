...
export const geometricPatterns: PatternDefinition[] = [
  {
    ...
    tileSize: 20,
    svg: svgToDataUri(
      `<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="1.5" fill="${BRAND_PURPLE}"/></svg>`
    ),
  },
  {
    id: 'geo-dots-large',
    ...
    tileSize: 40,
    svg: svgToDataUri(
      `<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="3" fill="${BRAND_PURPLE}"/></svg>`
    ),
  },
  {
    ...
    tileSize: 16,
    svg: svgToDataUri(
      `<svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M-4,4 l8,-8 M0,16 l16,-16 M12,20 l8,-8" stroke="${BRAND_PURPLE}" stroke-width="1" fill="none"/></svg>`
    ),
  },
  {
    id: 'geo-crosshatch',
    ...
    tileSize: 16,
    svg: svgToDataUri(
      `<svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M0,0 L16,16 M16,0 L0,16" stroke="${BRAND_PURPLE}" stroke-width="0.5" fill="none"/></svg>`
    ),
  },
  {
    id: 'geo-plus-signs',
    ...
    tileSize: 24,
    svg: svgToDataUri(
      `<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M12,8 v8 M8,12 h8" stroke="${BRAND_PURPLE}" stroke-width="1.5" stroke-linecap="round" fill="none"/></svg>`
    ),
  },
  {
    id: 'geo-hex-grid',
    ...
    tileSize: 28,
    svg: svgToDataUri(
      `<svg width="28" height="48" xmlns="http://www.w3.org/2000/svg"><path d="M14,0 L28,8 L28,24 L14,32 L0,24 L0,8 Z M14,32 L28,40 L28,48 M14,32 L0,40 L0,48" stroke="${BRAND_PURPLE}" stroke-width="0.75" fill="none"/></svg>`
    ),
  },
];
...
export const organicPatterns: PatternDefinition[] = [
  {
    ...
    tileSize: 60,
    svg: svgToDataUri(
      `<svg width="60" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M0,10 Q15,0 30,10 T60,10" stroke="${BRAND_PURPLE}" stroke-width="1" fill="none"/></svg>`
    ),
  },
  {
    id: 'org-circles-flow',
    ...
    tileSize: 50,
    svg: svgToDataUri(
      `<svg width="50" height="50" xmlns="http://www.w3.org/2000/svg"><circle cx="25" cy="25" r="20" stroke="${BRAND_PURPLE}" stroke-width="0.75" fill="none"/><circle cx="0" cy="0" r="15" stroke="${BRAND_PURPLE}" stroke-width="0.5" fill="none"/><circle cx="50" cy="50" r="15" stroke="${BRAND_PURPLE}" stroke-width="0.5" fill="none"/></svg>`
    ),
  },
  {
    ...
    tileSize: 40,
    svg: svgToDataUri(
      `<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="1" fill="${BRAND_PURPLE}"/><circle cx="28" cy="15" r="1.5" fill="${BRAND_PURPLE}"/><circle cx="15" cy="32" r="1" fill="${BRAND_PURPLE}"/><circle cx="35" cy="35" r="0.75" fill="${BRAND_PURPLE}"/></svg>`
    ),
  },
  {
    id: 'org-arcs',
    ...
    tileSize: 40,
    svg: svgToDataUri(
      `<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"><path d="M0,40 Q20,20 40,40" stroke="${BRAND_PURPLE}" stroke-width="1" fill="none"/><path d="M0,0 Q20,20 40,0" stroke="${BRAND_PURPLE}" stroke-width="0.5" fill="none"/></svg>`
    ),
  },
];
...
export const minimalPatterns: PatternDefinition[] = [
  {
    ...
    tileSize: 32,
    svg: svgToDataUri(
      `<svg width="32" height="32" xmlns="http://www.w3.org/2000/svg"><path d="M32,0 L32,32 M0,32 L32,32" stroke="${BRAND_PURPLE}" stroke-width="0.5" fill="none"/></svg>`
    ),
  },
  {
    id: 'min-fine-lines',
    ...
    tileSize: 8,
    svg: svgToDataUri(
      `<svg width="8" height="8" xmlns="http://www.w3.org/2000/svg"><path d="M0,8 L8,8" stroke="${BRAND_PURPLE}" stroke-width="0.25" fill="none"/></svg>`
    ),
  },
  {
    id: 'min-corners',
    ...
    tileSize: 24,
    svg: svgToDataUri(
      `<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M0,6 L0,0 L6,0 M18,0 L24,0 L24,6 M24,18 L24,24 L18,24 M6,24 L0,24 L0,18" stroke="${BRAND_PURPLE}" stroke-width="0.75" fill="none"/></svg>`
    ),
  },
  {
    id: 'min-tiny-dots',
    ...
    tileSize: 12,
    svg: svgToDataUri(
      `<svg width="12" height="12" xmlns="http://www.w3.org/2000/svg"><circle cx="6" cy="6" r="0.5" fill="${BRAND_PURPLE}"/></svg>`
    ),
  },
];
...
export const staticFilePatterns: PatternDefinition[] = [
  ...
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/comp-radius-new.svg',
  },
  {
  ...
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/apartment-units.svg',
  },
  {
  ...
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/property-network.svg',
  },
  // Neighborhood
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-1.svg',
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-2.svg',
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-3.svg',
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-4.svg',
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-5.svg',
  },
  {
    ...
    defaultOpacity: 1,
    tileSize: 300,
    svg: '/patterns/city-blocks-6.svg',
  },
  // Metro / Submarket
  {
    id: 'pattern-metro-1',
...
// Utility functions
export const findPatternById = (id: string): PatternDefinition | undefined => allPatterns.find((p) => p.id === id);
